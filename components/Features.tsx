...
const Features = () => {
  ...
  return (
    <div ref={ref} className="relative my-16 lg:my-24  bg-rose-900/50">
        ...
        <div className="gap-20 flex flex-col lg:grid  lg:grid-cols-2">
          <div>
            ...
            <p className="paragraph">
              ...
              our expertise, you can take your digital presence to the next
              level, achieve your business goals with confidence and out-compete
              your competition.
            </p>
          </div>
          <div>
